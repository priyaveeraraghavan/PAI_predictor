...
#seqdata = np.genfromtxt(data_file, delimiter=',', usecols=(1,2), skip_header=1)[:,:]
#whole_file = pd.read_csv(data_file)
#seqdata = whole_file['Seq']

#seqdata = whole_file.as_matrix(columns=whole_file['Seq'])
#print seqdata.shape
