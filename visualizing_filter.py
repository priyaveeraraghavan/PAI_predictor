...
def visualize_excitations():
  ...
  with tf.Graph().as_default():
    ...
    with tf.Session() as sess:
      ...
      if FLAGS.excitation_layer == 'conv1':
        channels=np.asarray([0,1, 2, 3])   # first, 31st, and last channels
      ...
      elif FLAGS.excitation_layer == 'pool1':
        neurons=np.asarray([[0,0,0],     # top-left corner of first map
                            [5,5,12],    # bottom-right corner of last map
